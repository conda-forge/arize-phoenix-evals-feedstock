About arize-phoenix-evals-feedstock
===================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/arize-phoenix-evals-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/arize-phoenix-evals-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add arize-phoenix-evals
# for installing globally
pixi global install arize-phoenix-evals
```
...
It is possible to list all of the versions of `arize-phoenix-evals` available on your platform:
...
```
pixi search arize-phoenix-evals --channel conda-forge
```
